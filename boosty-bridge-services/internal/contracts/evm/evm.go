...
func NewKeyedTransactorWithChainID(ctx context.Context, signerAddress common.Address, chainID *big.Int, sign func([]byte) ([]byte, error)) (*bind.TransactOpts, error) {
	if chainID == nil {
	...
	return &bind.TransactOpts{
		...
		Signer: func(address common.Address, tx *types.Transaction) (*types.Transaction, error) {
			...
			signature, err := sign(signer.Hash(tx).Bytes())
			if err != nil {
				return nil, err
			}
