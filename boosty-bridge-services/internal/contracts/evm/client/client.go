...
import (
	...
	evm_chain "github.com/BoostyLabs/casper-eth-bridge/boosty-bridge-services/chains/evm"
...
func NewClient(ctx context.Context, config Config, signerAddress common.Address, sign func([]byte) ([]byte, error)) (evm_chain.Transfer, error) {
