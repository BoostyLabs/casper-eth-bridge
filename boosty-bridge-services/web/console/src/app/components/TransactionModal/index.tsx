            ...
            <div className="transaction__wrapper">
                ...
                {isTransactionProgressStarted
                    ...
                    <div className="transaction__buttons">
                        ...
                        <button aria-label="Confirm transaction" className="transaction__confirm-btn" onClick={isCasperActiveNetwork ? sendCasperTransaction : sendMetamaskTransaction}>Confirm</button>
                    </div>
                }
            </div>
        </Modal>
