...
// Error is a default error type for avalanche connector cli.
var Error = errs.Class("avalanche connector cli")
...
var (
	rootCmd = &cobra.Command{
		Use:   "connector",
		Short: "cli for interacting with avalanche connector project",
	}
...
func cmdRun(cmd *cobra.Command, args []string) (err error) {
	...
	err = godotenv.Overload("./configs/.avalanche.env")
	if err != nil {
		log.Error("could not load avalanche config: %v", Error.Wrap(err))
